...
impl Quaternion {
    ...
    pub fn from_axis_angle(axis: &Vector3, angle: f64) -> Self {
        ...
        Quaternion::new(axis[0] * s, axis[1] * s, axis[2] * s, half_angle.cos())
    }
    ...
    pub fn rotx(angle: f64) -> Self {
        let half_angle = angle / 2.0;
        Quaternion::new(half_angle.sin(), 0.0, 0.0, half_angle.cos())
    }
    ...
    pub fn roty(angle: f64) -> Self {
        let half_angle = angle / 2.0;
        Quaternion::new(0.0, half_angle.sin(), 0.0, half_angle.cos())
    }
    ...
    pub fn rotz(angle: f64) -> Self {
        let half_angle = angle / 2.0;
        Quaternion::new(0.0, 0.0, half_angle.sin(), half_angle.cos())
    }
    ...
    pub fn derivative(&self, omega: &Vector3) -> Quaternion {
        let q = Quaternion::new(omega[0], omega[1], omega[2], 0.0);
    ...
    pub fn integrate_inplace_rk4(&mut self, omega: &Vector3, dt: f64) {
        let f = |_, q: &Quaternion| q.derivative(omega);
        crate::rk4_integrate_inplace(f, 0.0, self, dt);
...
/// ```
///
impl std::ops::MulAssign<Quaternion> for Quaternion {
