...
impl Instant {
    ...
    pub fn from_string(s: &str) -> SCResult<Instant> {
    ...
    /// Instant: The instant object
    ///
    pub fn strptime(s: &str, format: &str) -> SCResult<Instant> {
    ...
    /// # Returns:
    ///   Instant: The instant object
    pub fn from_rfc3339(rfc3339: &str) -> crate::SCResult<Self> {
    ...
    ///
    pub fn strftime(&self, format: &str) -> SCResult<String> {
